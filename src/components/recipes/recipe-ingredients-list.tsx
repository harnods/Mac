  ...
  return (
    <div className="space-y-4">
      ...
      {filtered.length === 0 ? (
        ...
        <div>
          <div className="grid grid-cols-[2rem_1fr_auto_7rem] gap-x-6 py-2 border-b text-xs text-muted-foreground">
            <span />
          ...
          {filtered.map(({ ri, line }, idx) => (
            <div key={ri.id} className="grid grid-cols-[2rem_1fr_auto_7rem] gap-x-6 items-center py-2 border-b last:border-0">
