  ...
  return (
    <div className="space-y-4">
      ...
      {filtered.length === 0 ? (
        ...
        <div>
          <div className="grid grid-cols-[2rem_1fr_auto] gap-x-6 py-2 border-b text-xs text-muted-foreground">
            <span />
            <span>Item</span>
            <span>Requested qty</span>
          </div>
          {filtered.map((ri, idx) => (
            <div key={ri.id} className="grid grid-cols-[2rem_1fr_auto] gap-x-6 items-center py-2 border-b last:border-0">
